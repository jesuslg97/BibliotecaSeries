                ...
                <div class="offset-md-4 col-4 mt-3">
                    <form name="create_director" action="" method="POST">
                        <div class="mb-3">
                            ...
                            <input id="directorName" name="directorName" type="text" placeholder="Introduce el nombre del director" class="form-control mb-3" required/>

                            <label for="directorSurnames" class="form-label">Apellidos del director</label>
                            <input id="directorSurnames" name="directorSurnames" type="text" placeholder="Introduce los apellidos del director" class="form-control mb-3" required/>

                            <label for="directorDate" class="form-label">Fecha nacimiento</label>
                            <input id="directorDate" name="directorDate" type="date" placeholder="Introduce la fecha de nacimiento" class="form-control mb-3" required/>
