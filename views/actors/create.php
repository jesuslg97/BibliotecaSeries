                ...
                <div class="offset-md-4 col-4 mt-3">
                    <form name="create_actor" action="" method="POST">
                        <div class="mb-3">
                            ...
                            <input id="actorName" name="actorName" type="text" placeholder="Introduce el nombre del actor" class="form-control mb-3" required/>

                            <label for="actorSurnames" class="form-label">Apellidos del actor</label>
                            <input id="actorSurnames" name="actorSurnames" type="text" placeholder="Introduce los apellidos del actor" class="form-control mb-3" required/>

                            <label for="actorDate" class="form-label">Fecha nacimiento</label>
                            <input id="actorDate" name="actorDate" type="date" placeholder="Introduce la fecha de nacimiento" class="form-control mb-3" required/>
